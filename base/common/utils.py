...
# COUNTRY_CODE_CHOICES = ((x, x) for x in sorted(countries.__iter__(), key=countries[0:]))
# # COUNTRY_CODE_CHOICES = ((x, x) for x in sorted(CountryTuple, key=str.lower))
